...
class VNPay
{
     ...
     *
     */
    static $vnp_TmnCode = "K5VUTKAL"; //Mã website tại VNPAY
    static $vnp_HashSecret = "IHBFKCKLAPXWTIKIIKWSWNGAVFJUDLXP"; //Chuỗi bí mật
    ...
    public static function vnpay_create_payment(array $data)
    {
        ...
        $vnp_OrderType = 160000; // Loại hàng hóa: Thể thao- dã ngoại (Xem thêm mã tại: https://sandbox.vnpayment.vn/apis/docs/loai-hang-hoa)
